...
```bash
sam-app2$ sam build --use-container
```
...
```bash
sam-app2$ pip install -r tests/requirements.txt --user
# unit test
sam-app2$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
sam-app2$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
